...
def summarize_conversation(transcipt, api_key1, ibm_cloud_url, project_id):
...
if __name__ == "__main__":
    ...
    # api_key = 'sgxi2C0PZ4eP2PwhYNtsVlPc12oo4WfgetU5Wy8_KSlv'
    ...
    speech_recognition_results = transcribe_audio(api_key,service_url,audio_file_path)
    ...
    print("Time taken in Mins: ",(time.time()-start)/60)
